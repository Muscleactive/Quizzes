...
<style>
  ...
  .bmi-info { font-size: 18px; margin-top: 15px; color: #444; text-align: center; }
  #retake, #blog-link { display: none; background-color: #4a7c59; margin-top: 20px; }
  #retake:hover, #blog-link:hover { background-color: #1e4124; }
</style>
</head>
<body>
...
<div class="container">
  ...
  <button id="retake" onclick="resetQuiz()">Retake Quiz</button>
  <button id="blog-link" onclick="window.open('https://keepwellnutrition.com/blog/f/how-many-calories-do-you-really-need', '_blank')">Read Full Blog</button>
</div>
...
function calculateCalories() {
  ...
  else if (bmi < 25) category = "a healthy weight";
  ...
  document.getElementById('bmi-info').innerText = `Your BMI is ${bmi}, which is considered ${category}.`;
  document.getElementById('retake').style.display = 'block';
  document.getElementById('blog-link').style.display = 'block';
}
...
function resetQuiz() {
  ...
  document.getElementById('bmi-info').innerText = "";
